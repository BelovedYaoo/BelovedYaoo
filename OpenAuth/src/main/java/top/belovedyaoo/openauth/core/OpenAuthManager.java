...
import top.belovedyaoo.openauth.dao.OpenAuthDaoDefaultImpl;
import top.belovedyaoo.openauth.data.convert.OpenAuthDataConverter;
import top.belovedyaoo.openauth.data.convert.OpenAuthDataConverterDefaultImpl;
import top.belovedyaoo.openauth.data.generate.OpenAuthDataGenerate;
import top.belovedyaoo.openauth.data.generate.OpenAuthDataGenerateDefaultImpl;
import top.belovedyaoo.openauth.data.loader.OpenAuthDataLoader;
import top.belovedyaoo.openauth.data.loader.OpenAuthDataLoaderDefaultImpl;
import top.belovedyaoo.openauth.data.resolver.OpenAuthDataResolver;
import top.belovedyaoo.openauth.data.resolver.OpenAuthDataResolverDefaultImpl;
